...
from llavamod.model.language_model.llava_qwen_moe import EvalLLaVAMoDQWenForCausalLM
from llavamod.model.language_model.llava_qwen import LlavaQWenForCausalLM

from llavamod.model.language_model.llava_llama_moe import EvalLLaVAMoDLlamaForCausalLM
from llavamod.model.language_model.llava_llama import LlavaLlamaForCausalLM

import transformers

a, b, c = transformers.__version__.split('.')[:3]
if a == '4' and int(b) >= 34:
    from llavamod.model.language_model.llava_mistral_moe import EvalLLaVAMoDMistralForCausalLM
    from llavamod.model.language_model.llava_mistral import LlavaMistralForCausalLM
if a == '4' and int(b) >= 36:
    from llavamod.model.language_model.llava_minicpm_moe import EvalLLaVAMoDMiniCPMForCausalLM
    from llavamod.model.language_model.llava_minicpm import LlavaMiniCPMForCausalLM
    from llavamod.model.language_model.llava_phi_moe import EvalLLaVAMoDPhiForCausalLM
    from llavamod.model.language_model.llava_phi import LlavaPhiForCausalLM
    from llavamod.model.language_model.llava_stablelm_moe import EvalLLaVAMoDStablelmForCausalLM
    from llavamod.model.language_model.llava_stablelm import LlavaStablelmForCausalLM
if a == '4' and int(b) >= 37:
    from llavamod.model.language_model.llava_qwen1_5_moe import EvalLLaVAMoDQwen1_5ForCausalLM
    from llavamod.model.language_model.llava_qwen1_5 import LlavaQwen1_5ForCausalLM
    from llavamod.model.language_model.llava_qwen2_moe import EvalLLaVAMoDQwen2ForCausalLM
    from llavamod.model.language_model.llava_qwen2 import LlavaQwen2ForCausalLM
    from llavamod.model.language_model.llava_gemma2_moe import EvalLLaVAMoDGemma2ForCausalLM
    from llavamod.model.language_model.llava_gemma2 import LlavaGemma2ForCausalLM
...
from llavamod.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, \
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and 'moe' not in model_name.lower() and model_base is not None:
            ...
            if 'qwen' in model_base.lower() and '1.5' not in model_base.lower():
                model = LlavaQWenForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                             config=lora_cfg_pretrained, **kwargs)
                model.generation_config = GenerationConfig.from_pretrained(model_base,
                ...
                model = LlavaQwen1_5ForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'phi' in model_base.lower():
                model = LlavaPhiForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                            config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'minicpm' in model_base.lower():
                model = LlavaMiniCPMForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'stablelm' in model_base.lower():
                model = LlavaStablelmForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                 config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            else:
            ...
            if 'qwen' in model_name.lower() and '1.5' not in model_name.lower():
                ...
                model = EvalLLaVAMoDQWenForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                    config=lora_cfg_pretrained, **kwargs)
                ...
                model = EvalLLaVAMoDMistralForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                       config=lora_cfg_pretrained, **kwargs)
            elif 'qwen' in model_name.lower() and '1.5' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalLLaVAMoDQwen1_5ForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                # import ipdb
                # ipdb.set_trace()
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'phi' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalLLaVAMoDPhiForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                   config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'minicpm' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalLLaVAMoDMiniCPMForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                       config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
                ...
                model = EvalLLaVAMoDStablelmForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                        config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            else:
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalLLaVAMoDLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                     config=lora_cfg_pretrained, **kwargs)
            if not merge:
                import deepspeed
            ...
            # =============================================================================================
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDMistralForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDPhiForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                       config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDQwen1_5ForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                           config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDMiniCPMForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                           config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                ...
                from llavamod.model.language_model.stablelm.tokenization_arcade100k import Arcade100kTokenizer
                from llavamod.model.language_model.stablelm.configuration_stablelm_epoch import StableLMEpochConfig
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDStablelmForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                            config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                ...
                cfg_pretrained = AutoConfig.from_pretrained(model_path)
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDQWenForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                        config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                ...
                cfg_pretrained = AutoConfig.from_pretrained(model_path)
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalLLaVAMoDLlamaForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
                                                                         config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
            ...
            if 'qwen' in model_name.lower():
                if 'qwen1.5' in model_name.lower() or 'qwen-1.5' in model_name.lower():
                    tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                    # print(tokenizer)
                    if 'moe' in model_name.lower():
                        assert not load_8bit and not load_4bit  # FIXME
                        model = EvalLLaVAMoDQwen1_5ForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                               **kwargs)
                        import deepspeed
                        deepspeed.init_distributed(dist_backend='nccl')
                        # Initialize the DeepSpeed-Inference engine
                    ...
                    # print(tokenizer)
                    if 'moe' in model_name.lower():
                        print("#### init qwen2 moe....")
                        assert not load_8bit and not load_4bit  # FIXME
                        model = EvalLLaVAMoDQwen2ForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                             **kwargs)
                        # 打印初始参数类型
                        print("######### Initial parameter dtypes")
                        ...
                        ds_engine = deepspeed.init_inference(model,
                                                             ...
                                                             replace_with_kernel_inject=False)
                        model = ds_engine.module
                        # print("######### Parameter dtypes after DeepSpeed initialization")
                        # for name, param in model.named_parameters():
                        #     print(name, param.dtype)
                        # import pdb;pdb.set_trace()
                    else:
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalLLaVAMoDGemma2ForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True,
                                                                          **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalLLaVAMoDMistralForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalLLaVAMoDPhiForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalLLaVAMoDMiniCPMForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalLLaVAMoDLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # print(model)
                    # Initialize the DeepSpeed-Inference engine
