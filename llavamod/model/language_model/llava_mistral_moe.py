...
class LLaVAMoDMistralConfig(MistralConfig):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDMistralConfig, self).__init__(**kwargs)


class LLaVAMoDMistralModel(LlavaMetaModel, MistralModel):
    config_class = LLaVAMoDMistralConfig

    def __init__(self, config: MistralConfig):
        super(LLaVAMoDMistralModel, self).__init__(config)
...
class LLaVAMoDMistralForCausalLM(MistralForCausalLM, LlavaMetaForCausalLM):
    config_class = LLaVAMoDMistralConfig

    def __init__(self, config):
        super(MistralForCausalLM, self).__init__(config)
        self.model = LLaVAMoDMistralModel(config)
...
class EvalLLaVAMoDMistralForCausalLM(LLaVAMoDMistralForCausalLM):
    config_class = LLaVAMoDMistralConfig

    def __init__(self, config):
        super(EvalLLaVAMoDMistralForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_mistral", LLaVAMoDMistralConfig)
AutoModelForCausalLM.register(LLaVAMoDMistralConfig, LLaVAMoDMistralForCausalLM)

AutoModelForCausalLM.register(LLaVAMoDMistralConfig, EvalLLaVAMoDMistralForCausalLM)
