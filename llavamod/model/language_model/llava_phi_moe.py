...
class LLaVAMoDPhiConfig(PhiConfig):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDPhiConfig, self).__init__(**kwargs)


class LLaVAMoDPhiModel(LlavaMetaModel, PhiModel):
    config_class = LLaVAMoDPhiConfig

    def __init__(self, config: PhiConfig):
        super(LLaVAMoDPhiModel, self).__init__(config)
...
class LLaVAMoDPhiForCausalLM(PhiForCausalLM, LlavaMetaForCausalLM):
    config_class = LLaVAMoDPhiConfig

    def __init__(self, config):
        super(PhiForCausalLM, self).__init__(config)
        self.model = LLaVAMoDPhiModel(config)
...
class EvalLLaVAMoDPhiForCausalLM(LLaVAMoDPhiForCausalLM):
    config_class = LLaVAMoDPhiConfig

    def __init__(self, config):
        super(EvalLLaVAMoDPhiForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_phi", LLaVAMoDPhiConfig)
AutoModelForCausalLM.register(LLaVAMoDPhiConfig, LLaVAMoDPhiForCausalLM)

AutoModelForCausalLM.register(LLaVAMoDPhiConfig, EvalLLaVAMoDPhiForCausalLM)
