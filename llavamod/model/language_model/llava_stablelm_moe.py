...
class LLaVAMoDStablelmConfig(StableLMEpochConfig):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDStablelmConfig, self).__init__(**kwargs)


class LLaVAMoDStablelmModel(LlavaMetaModel, StableLMEpochModel):
    config_class = LLaVAMoDStablelmConfig

    def __init__(self, config: StableLMEpochConfig):
        super(LLaVAMoDStablelmModel, self).__init__(config)
...
class LLaVAMoDStablelmForCausalLM(StableLMEpochForCausalLM, LlavaMetaForCausalLM):
    config_class = LLaVAMoDStablelmConfig

    def __init__(self, config):
        super(StableLMEpochForCausalLM, self).__init__(config)
        self.model = LLaVAMoDStablelmModel(config)
...
class EvalLLaVAMoDStablelmForCausalLM(LLaVAMoDStablelmForCausalLM):
    config_class = LLaVAMoDStablelmConfig

    def __init__(self, config):
        super(EvalLLaVAMoDStablelmForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_stablelm", LLaVAMoDStablelmConfig)
AutoModelForCausalLM.register(LLaVAMoDStablelmConfig, LLaVAMoDStablelmForCausalLM)

AutoModelForCausalLM.register(LLaVAMoDStablelmConfig, EvalLLaVAMoDStablelmForCausalLM)
