...
from .qwen1_5.modeling_qwen2 import Qwen2Config, Qwen2Model, Qwen2ForCausalLM
...
def rank0_print(*args, **kwargs):
    """
    A utility function to print only from the process with rank 0.
    """
    if dist.is_initialized():
        if dist.get_rank() == 0:
            print(*args, **kwargs)
    else:
        # If distributed training is not set up, print as usual.
        print(*args, **kwargs)
...
class LlavaQwen1_5ForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        # rank0_print("####### input_ids before prepare_inputs_labels_for_multimodal")
        # rank0_print(input_ids)
        # if input_ids is not None:
        #     rank0_print(input_ids.size())
        # rank0_print("####### input_embeds before prepare_inputs_labels_for_multimodal")
        # rank0_print(inputs_embeds)
        # if inputs_embeds is not None:
        #     rank0_print(inputs_embeds.size())
        # rank0_print("####### labels before prepare_inputs_labels_for_multimodal")
        # rank0_print(labels)
        # rank0_print(labels.size())
        ...
        # rank0_print("####### input_ids after prepare_inputs_labels_for_multimodal")
        # rank0_print(input_ids)
        # if input_ids is not None:
        #     rank0_print(input_ids.size())
        # rank0_print("####### input_embeds after prepare_inputs_labels_for_multimodal")
        # rank0_print(inputs_embeds)
        # if inputs_embeds is not None:
        #     rank0_print(inputs_embeds.size())
        # rank0_print("####### labels after prepare_inputs_labels_for_multimodal")
        # rank0_print(labels)
        # rank0_print(labels.size())
