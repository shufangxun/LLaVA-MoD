...
class LLaVAMoDQWenConfig(QWenConfig):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDQWenConfig, self).__init__(**kwargs)


class LLaVAMoDQWenModel(LlavaMetaModel, QWenModel):
    config_class = LLaVAMoDQWenConfig

    def __init__(self, config: QWenConfig):
        super(LLaVAMoDQWenModel, self).__init__(config)
...
class LLaVAMoDQWenForCausalLM(QWenLMHeadModel, LlavaQWenMetaForCausalLM):
    config_class = LLaVAMoDQWenConfig
    ...
    def __init__(self, config):
        ...
        self.transformer = LLaVAMoDQWenModel(config)
...
class LLaVAMoDQWenForCausalLMFineTune(LLaVAMoDQWenForCausalLM):
    config_class = LLaVAMoDQWenConfig

    def __init__(self, config):
        super(LLaVAMoDQWenForCausalLMFineTune, self).__init__(config)
...
class EvalLLaVAMoDQWenForCausalLM(LLaVAMoDQWenForCausalLM):
    config_class = LLaVAMoDQWenConfig

    def __init__(self, config):
        super(EvalLLaVAMoDQWenForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_qwen", LLaVAMoDQWenConfig)
AutoModelForCausalLM.register(LLaVAMoDQWenConfig, LLaVAMoDQWenForCausalLM)
AutoModelForCausalLM.register(LLaVAMoDQWenConfig, LLaVAMoDQWenForCausalLMFineTune)
AutoModelForCausalLM.register(LLaVAMoDQWenConfig, EvalLLaVAMoDQWenForCausalLM)
