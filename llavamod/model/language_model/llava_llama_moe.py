...
class LLaVAMoDLlamaConfig(LlamaConfig):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDLlamaConfig, self).__init__(**kwargs)


class LLaVAMoDLlamaModel(LlavaMetaModel, LlamaModel):
    config_class = LLaVAMoDLlamaConfig

    def __init__(self, config: LlamaConfig):
        super(LLaVAMoDLlamaModel, self).__init__(config)
...
def MoELlamaDecoderLayer_forward_before(self):
    def forward(
            # self,
...
def MoELlamaModel_forward_before(self):
    def forward(
            # self,
...
def MoELlamaModel_forward(self):
    def forward(
        ...
        if not return_dict:
            return tuple(v for v in [hidden_states, next_cache, all_hidden_states, all_self_attns, all_moe_loss] if
                         v is not None)
        return MoEBaseModelOutputWithPast(
            last_hidden_state=hidden_states,
            past_key_values=next_cache,
...
class LLaVAMoDLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    config_class = LLaVAMoDLlamaConfig

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = LLaVAMoDLlamaModel(config)
...
class EvalLLaVAMoDLlamaForCausalLM(LLaVAMoDLlamaForCausalLM):
    config_class = LLaVAMoDLlamaConfig

    def __init__(self, config):
        super(EvalLLaVAMoDLlamaForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_llama", LLaVAMoDLlamaConfig)
AutoModelForCausalLM.register(LLaVAMoDLlamaConfig, LLaVAMoDLlamaForCausalLM)

AutoModelForCausalLM.register(LLaVAMoDLlamaConfig, EvalLLaVAMoDLlamaForCausalLM)
