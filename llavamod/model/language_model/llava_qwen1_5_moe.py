...
class LLaVAMoDQwen1_5Config(Qwen2Config):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDQwen1_5Config, self).__init__(**kwargs)


class LLaVAMoDQwen1_5Model(LlavaMetaModel, Qwen2Model):
    config_class = LLaVAMoDQwen1_5Config

    def __init__(self, config: Qwen2Config):
        super(LLaVAMoDQwen1_5Model, self).__init__(config)
...
class LLaVAMoDQwen1_5ForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    config_class = LLaVAMoDQwen1_5Config

    def __init__(self, config):
        super(Qwen2ForCausalLM, self).__init__(config)
        self.model = LLaVAMoDQwen1_5Model(config)
...
class LLaVAMoDQwen1_5ForCausalLMFineTune(LLaVAMoDQwen1_5ForCausalLM):
    config_class = LLaVAMoDQwen1_5Config

    def __init__(self, config):
        super(LLaVAMoDQwen1_5ForCausalLMFineTune, self).__init__(config)
        # print(config)
...
class EvalLLaVAMoDQwen1_5ForCausalLM(LLaVAMoDQwen1_5ForCausalLM):
    config_class = LLaVAMoDQwen1_5Config

    def __init__(self, config):
        # print(config)
        super(EvalLLaVAMoDQwen1_5ForCausalLM, self).__init__(config)
        if getattr(self.config, 'lora', False) and self.config.lora.get('lora_enable', False):
            from peft import LoraConfig, get_peft_model
            pre_lora_config = self.config.lora
            lora_config = LoraConfig(
...
AutoConfig.register("moe_llava_qwen1_5", LLaVAMoDQwen1_5Config)
AutoModelForCausalLM.register(LLaVAMoDQwen1_5Config, LLaVAMoDQwen1_5ForCausalLM)
AutoModelForCausalLM.register(LLaVAMoDQwen1_5Config, LLaVAMoDQwen1_5ForCausalLMFineTune)
AutoModelForCausalLM.register(LLaVAMoDQwen1_5Config, EvalLLaVAMoDQwen1_5ForCausalLM)
