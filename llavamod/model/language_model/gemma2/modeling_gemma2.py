...
from ...import_utils import is_flash_attn_greater_or_equal
...
class Gemma2DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # print("582:", type(hidden_states), len(hidden_states))
        # print("582:", hidden_states)

        hidden_states = self.post_attention_layernorm(hidden_states)
        hidden_states = residual + hidden_states
        # print("588:", type(hidden_states), len(hidden_states))
        # print("588:", hidden_states)

        residual = hidden_states
        hidden_states = self.pre_feedforward_layernorm(hidden_states)
        hidden_states = self.mlp(hidden_states)
        # print("594:", type(hidden_states), len(hidden_states))
        # print("594:", hidden_states)

        hidden_states = self.post_feedforward_layernorm(hidden_states)
        hidden_states = residual + hidden_states
        # print("597:", type(hidden_states), len(hidden_states))
        # print("597:", hidden_states)
