...
class LLaVAMoDMiniCPMConfig(MiniCPMConfig):
    ...
    def __init__(self,
        ...
        super(LLaVAMoDMiniCPMConfig, self).__init__(**kwargs)


class LLaVAMoDMiniCPMModel(LlavaMetaModel, MiniCPMModel):
    config_class = LLaVAMoDMiniCPMConfig

    def __init__(self, config: MiniCPMConfig):
        super(LLaVAMoDMiniCPMModel, self).__init__(config)
...
class LLaVAMoDMiniCPMForCausalLM(MiniCPMForCausalLM, LlavaMetaForCausalLM):
    config_class = LLaVAMoDMiniCPMConfig

    def __init__(self, config):
        super(MiniCPMForCausalLM, self).__init__(config)
        self.model = LLaVAMoDMiniCPMModel(config)
...
class EvalLLaVAMoDMiniCPMForCausalLM(LLaVAMoDMiniCPMForCausalLM):
    config_class = LLaVAMoDMiniCPMConfig

    def __init__(self, config):
        super(EvalLLaVAMoDMiniCPMForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_minicpm", LLaVAMoDMiniCPMConfig)
AutoModelForCausalLM.register(LLaVAMoDMiniCPMConfig, LLaVAMoDMiniCPMForCausalLM)

AutoModelForCausalLM.register(LLaVAMoDMiniCPMConfig, EvalLLaVAMoDMiniCPMForCausalLM)
