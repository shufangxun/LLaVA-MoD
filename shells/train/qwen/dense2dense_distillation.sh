...
# Student
POLICY_LLM='Qwen/Qwen2-0.5B'
POLICY_MLP_ADAPTOR='./checkpoints/llavaqwen-2-0.5b-pretrain/mm_projector.bin'
...
# Output dir
OUTPUT_DIR='./checkpoints/llavaqwen-2-0.5b-d2d'

HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed llavamod/train/align_train.py \
    --deepspeed ${DEEPSPEED_CONFIG} \
    --ref_model_name_or_path ${REF_MLLM} \
    --policy_model_name_or_path ${POLICY_LLM} --policy_pretrain_mm_mlp_adapter ${POLICY_MLP_ADAPTOR} \
