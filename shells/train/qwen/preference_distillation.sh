...
# Student
POLICY_MLLM='./checkpoints/llavaqwen-2-0.5b-d2s'
...
# Output dir
OUTPUT_DIR='./checkpoints/llavaqwen-2-0.5b-pd'

HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed llavamod/train/dpo_train.py \
    ...
    --train_modules mlp.gate_proj mlp.up_proj mlp.down_proj wg deepspeed_experts \
